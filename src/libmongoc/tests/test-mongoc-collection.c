...
_test_update_hint (int wire, bool is_replace, bool is_multi, const char *hint)
{
   ...
   if (wire >= WIRE_VERSION_HINT_SERVER_SIDE_ERROR) {
      char* command = bson_strdup_printf("{'q': {}, 'u': {}, 'hint': %s %s }", hint, is_multi ? ", 'multi': true" : "");
...
{
   _test_update_hint (WIRE_VERSION_HINT_SERVER_SIDE_ERROR, false, false, "'_id_'");
   _test_update_hint (WIRE_VERSION_HINT_SERVER_SIDE_ERROR, false, true, "'_id_'");
   _test_update_hint (WIRE_VERSION_HINT_SERVER_SIDE_ERROR, true, false, "'_id_'");

   _test_update_hint (WIRE_VERSION_HINT_SERVER_SIDE_ERROR - 1, false, false, "'_id_'");
   _test_update_hint (WIRE_VERSION_HINT_SERVER_SIDE_ERROR - 1, false, true, "'_id_'");
   _test_update_hint (WIRE_VERSION_HINT_SERVER_SIDE_ERROR - 1, true, false, "'_id_'");

   _test_update_hint (WIRE_VERSION_HINT_SERVER_SIDE_ERROR, false, false, "{'_id': 1}");
   _test_update_hint (WIRE_VERSION_HINT_SERVER_SIDE_ERROR, false, true, "{'_id': 1}");
   _test_update_hint (WIRE_VERSION_HINT_SERVER_SIDE_ERROR, true, false, "{'_id': 1}");

   _test_update_hint (WIRE_VERSION_HINT_SERVER_SIDE_ERROR - 1, false, false, "{'_id': 1}");
   _test_update_hint (WIRE_VERSION_HINT_SERVER_SIDE_ERROR - 1, false, true, "{'_id': 1}");
   _test_update_hint (WIRE_VERSION_HINT_SERVER_SIDE_ERROR - 1, true, false, "{'_id': 1}");
}
